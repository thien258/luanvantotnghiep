...
<div style="margin-left: 280px; margin-top: 100px; padding: 20px;">
  ...
  <form action="{{route('admin.festival.update',['festival'=>$festival->id])}}" method="POST">
    ...
    <div class="mb-3">
      ...
      <input type="date" class="form-control" value="{{$festival->start_date}}" id="start_date" name="start_date" aria-describedby="emailHelp">  
    </div>
    <div class="mb-3">
      <label for="end_date" class="form-label">Thời gian kết thúc</label>
      <input type="date" class="form-control" value="{{$festival->end_date}}" id="end_date" name="end_date" aria-describedby="emailHelp">
    </div>
