...
<div class="card-footer small text-mutted">
    <h3>Category</h3>
    <a href="{{ route('admin.category.create') }}" class="btn btn-warning mb-3">Thêm</a>
    ...
    <table class="table text-center align-middle table-hover">
        ...
        <tbody>
                ...
                <td>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="dropdownMenu{{ $object->id }}">
                            <li>
                                <a class="dropdown-item" href="{{ route('admin.category.edit',['category' =>$object->id]) }}">
                            ...
                            {{-- <li>
                                ...
                                <form action="{{ route('admin.category.destroy', ['category' => $object->id]) }}" method="post" id="category-delete-{{ $object->id }}" class="d-none">
                                    {{ csrf_field() }}
                                    {{ method_field('delete') }}
                                </form>
                            </li> --}}
            ...
            @empty
            <tr>
                <td colspan="4" class="text-muted py-4">Không tìm thấy danh mục nào.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
