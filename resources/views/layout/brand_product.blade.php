      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          ...
          <div class="card border-0 h-100 text-center bg-transparent d-flex flex-column shadow-sm rounded-1 overflow-hidden">
            ...
            <a href="{{ route('single_product', ['brand'=>$product->id]) }}" class="d-block ratio ratio-1x1 bg-light text-decoration-none">
            ...
            <div class="card-body p-4 d-flex flex-column flex-grow-1 bg-white">
              ...
              <h5 class="card-title mb-2">
                <a href="{{ route('single_product', ['brand'=>$product->id]) }}" class="text-decoration-none text-dark fs-6 fw-bold">
                  {{ $product->title }}
                </a>
              </h5>
              ...
              <div class="mt-auto">
                ...
                <a href="{{ route('single_product', ['brand'=>$product->id]) }}" class="btn btn-outline-dark w-100 rounded-0 text-uppercase fw-bold py-2 small">
                  Xem chi tiết
                </a>
              </div>
            </div>
